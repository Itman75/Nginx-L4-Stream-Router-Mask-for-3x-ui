...
* **Строгий IPv4 Firewall (UFW):** Блокировка всех входящих соединений по умолчанию. Открытыми остаются только публичные порты SSH, `80/TCP`, `443/TCP/UDP` и `8443/TCP/UDP`. Служебные порты панели, подписок и Reality полностью скрыты от внешнего сканирования.
