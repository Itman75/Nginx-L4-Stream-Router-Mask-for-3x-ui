...
* **Гибкая установка:** Интерактивный выбор версии панели управления `3x-ui` (последний стабильный релиз или конкретный тег версии, например, `v2.9.4`). 
  > **Важно:** При использовании L4-маршрутизации панель должна функционировать без собственных SSL-сертификатов. При установке панели в интерактивном меню рекомендуется отказаться от автоматического выпуска сертификатов - в конце установки выбрать пункт 4 и `N`, так как трафик будет проксироваться через локальный интерфейс.
