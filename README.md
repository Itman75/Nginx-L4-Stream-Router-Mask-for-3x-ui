...
* **Гибкая установка:** Возможность развернуть панель `3x-ui` с выбором версии (стабильная latest или конкретный релиз, например - `v2.9.4`). 
  > **Важно:** Для использовании L4-маршрутизатора панель должна работать без собственных SSL-сертификатов. При установке панели выберите работу через localhost (в конце установки выбрать опция 4 и 'N' - отказ от автоматических сертификатов ).
