...
> Все DNS-записи доменов и поддоменов (`A`-записи для основного домена, поддомена DoH `dns.` и поддомена Steal `cdn.`) в Cloudflare **обязаны** находиться в режиме **DNS-Only (Серое облако)**!  
