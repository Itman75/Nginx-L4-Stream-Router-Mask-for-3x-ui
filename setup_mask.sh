...
read -rp "Введите ваш основной домен (например, proxy-hub.ru): " PRIMARY_DOMAIN
...
log "Генерация L4 Stream таблиц и Upstream-блоков..."
STREAM_MAP_RULES=""
REALITY_UPSTREAMS=""
...
server {
    ...
    listen 8443; 
    ssl_preread on;
    proxy_protocol on; # Передаем реальный IP клиента дальше
